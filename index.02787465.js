...
})({"lh6sd":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "caa43c7102787465";
"use strict";
...
},{}],"9ArsZ":[function(require,module,exports) {
...
var _index4 = require("./components/todo-item/index");
var _index5 = require("./pages/home/index");
var _state = require("./state");
console.log("Bienvenida/o a mi app de notitas!");
(function() {
    (0, _state.state).init();
    (0, _index1.initHeader)();
    (0, _index2.initFooter)();
    (0, _index.initForm)();
    (0, _index3.initTextComponent)();
    (0, _index4.initTodoItem)();
    const divEl = document.querySelector(".root");
    (0, _index5.initHomePage)(divEl);
})();

},{"./components/form/index":"5nsGj","./components/header/index":"3Vjwy","./components/footer/index":"jBE2R","./components/text/index":"0zHK6","./components/todo-item/index":"cs1sp","./pages/home/index":"6vLOO","./state":"jO80Z"}],"5nsGj":[function(require,module,exports) {
...
function initForm() {
  ...
  `;
            ...
            formEl?.addEventListener("submit", (e)=>{
                ...
                (0, _state.state).addTask(Math.floor(Math.random() * 1000 - 1) + 1, inputValue);
                inputEl.value = "";
            });
...
},{"../../state":"jO80Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jO80Z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    data: {
        tasks: [
            {
                id: 1,
                title: "Este es un ejemplo de como se mostrar\xe1 tu pendiente en la pantalla, si deseas, pod\xe9s eliminarlo y comenzar a agregar tus tareas a realizar!<br>Saludos!",
                completed: false
            },
            {
                id: 2,
...
},{}],"3Vjwy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jBE2R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"0zHK6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cs1sp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initTodoItem", ()=>initTodoItem);
var _state = require("../../state");
function initTodoItem() {
    class TodoItem extends HTMLElement {
        ...
        addlisteners() {
            ...
            this.addEventListener("delete-item", (e)=>{
                function confirmMessege() {
                    let resultado = window.confirm("Seguro/a que quer\xe9s eliminar este pendiente?");
                    if (resultado === true) (0, _state.state).changeItemDeletedState(e.detail.id, e.detail.value);
                }
                confirmMessege();
            });
        }
      ...
      <div>
      <input class="input checkbox-input" type="checkbox" ${this.checked ? "checked" : ""}/>
        </div>
        </div>
...
},{"../../state":"jO80Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6vLOO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initHomePage(containerEl) {
  ...
  <todo-form></todo-form>
    ...
    (0, _state.state).subscribe(()=>{
        createTasks((0, _state.state).getEnabledTasks());
    });
    createTasks(tasks);
    containerEl.appendChild(div);
}

},{"../../state":"jO80Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lh6sd","9ArsZ"], "9ArsZ", "parcelRequire99ae")

//# sourceMappingURL=index.02787465.js.map
